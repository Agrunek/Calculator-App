...
class AdvancedCalculatorActivity : AppCompatActivity() {
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        savedInstanceState.run {
            ...
            getSerializable(STATE_3, ExpandedOperationMode::class.java)?.let { operationIntent = it }
            getSerializable(STATE_4, ExpandedOperationMode::class.java)?.let { operationLocked = it }
